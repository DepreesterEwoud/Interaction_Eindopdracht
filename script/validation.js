...
const enableListeners = function() {
	...
	signInButton.addEventListener('click', function(e) {
		...
		if (
            ...
            document.getElementById("username").classList.add("c-hide-input");
            document.getElementById("buttonstandard").classList.add("c-button-display");
            document.getElementById("buttonsubscribed").classList.remove("c-button-subscribed-none");
            document.getElementById("buttonsubscribed").classList.add("c-button-subscribed");
		} else {
			// Stuk herhalende code...
